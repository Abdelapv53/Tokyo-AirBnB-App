        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:allendelavirgen53@gmail.com'), 
                    ...
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/allendelav'), 
                ], 
                className='lead'
            )
        )
